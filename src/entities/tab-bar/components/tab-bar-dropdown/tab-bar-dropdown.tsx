...
import { UiDropdownOption } from '@/src/shared/ui/ui-dropdown-option/ui-dropdown-option';
import { HiddenTabProps } from '@/src/entities/tab-bar/components/tab-bar-dropdown/tab-bar-dropdown-props';
