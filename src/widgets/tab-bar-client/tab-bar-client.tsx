...
import { DraggableTabBar } from '@/src/shared/components/drag-and-drop/draggable-tab-bar/draggable-tab-bar';
import { TabDropdown } from '@/src/entities/tab-bar/components/tab-bar-dropdown/tab-bar-dropdown';
import { useTabsStore } from '@/src/shared/store/tabs-store/pinned-tabs.store';
import { TabsData } from '@/src/entities/tab-bar/tabs-array';
import { useHiddenTabs } from '@/src/shared/hooks/use-hidden-tabs.hook';
...
export default function TabBarClient() {
  ...
  const { pinnedIds, orderedIds, togglePin, reorder, hydrate } = useTabsStore();
